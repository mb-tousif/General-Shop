    ...
    <Dialog open={open} onClose={handleClose}>
      <Box sx={{ display: "flex"}}>
        <Box sx={{ background: "#321575", height: "100%", border: "5px", width: "40%", color: "rgb(249 250 251)", overflow: "hidden" }}>
          ...
          <Box sx={{display:"flex", justifyItem: "center", justifyContent: "center"}}><img src={login} width="70%" height="200" alt="log" /></Box>
        </Box>
        {
          account.view === "login" ?
        ...
        :
        <Box sx={{width: "60%",display: 'flex', flexDirection: 'column', padding: "25px 35px", flex: 1}}>
          <TextField marginTop='20px' label="Enter First Name" variant="standard" />
          <TextField marginTop='20px' label="Enter Last Name" variant="standard"/>
          <TextField marginTop='20px' label="Enter Username" variant="standard"/>
          <TextField marginTop='20px' label="Enter Email" variant="standard"/>
          <TextField marginTop='20px' label="Enter Password" variant="standard"/>
          <TextField marginTop='20px' label="Enter Phone Number" variant="standard"/>
